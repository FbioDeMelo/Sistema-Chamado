...
SECRET_KEY = 'django-insecure-d79jd3dhz9d&f9s(@0**mpm_%-!ae0x#=_9xerq8j-1q#-@dez'
...
# URL para onde o usuário não logado será redirecionado
LOGIN_URL = '/login/'

# URL para onde o usuário vai após o login, se não houver "next" especificado
LOGIN_REDIRECT_URL = '/'
